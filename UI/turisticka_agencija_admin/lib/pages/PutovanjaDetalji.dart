...
import 'package:turisticka_agencija_admin/models/Putovanja.dart';

import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:turisticka_agencija_admin/providers/komentar_provider.dart';
import 'package:turisticka_agencija_admin/providers/korisnici_provider.dart';
import 'package:turisticka_agencija_admin/providers/ocjene_provider.dart';
import 'package:turisticka_agencija_admin/utils/util.dart';
...
class PutovanjaDetalji extends StatelessWidget {
  ...
  Future<List<Putovanja?>> getRecomendedPutovanja() async {
    ...
    if (putovanja != null) {
      ...
      return putovanjaTemp!
          .map((i) => _putovanjaProvider?.fromJson(i))
          .toList();
    }
  }
  ...
  Future<Komentar?> addKomentar(String sadrzaj) async {
    ...
    var korisniciList =
        korisnici!.map((i) => _korisniciProvider?.fromJson(i)).toList();
